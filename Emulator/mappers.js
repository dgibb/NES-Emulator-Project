...
const mapper0 = {
  ...
  readByte(addr) {
    switch (addr & 0xF000) {
      ...
      case 0x4000:
      case 0x5000:
        // show relevant info when invalid memory is accessed
...
const mapper1 = {
  ...
  setChrBank1() {
    if (mapper1.chrBankMode === 1) {
      ...
      mapper1.chrBankOffset[1] *= 0x1000;
    }
  },
...
const mapperInit = function mapperInit(mapper) {
  memory.mapper = mapperMap[mapper];
  memory.mapper.init();
};

const mapperMap = [mapper0, mapper1, 0, 0, mapper4];

module.exports = {
  mapper0, mapper1, mapper4, mapperInit,
};
